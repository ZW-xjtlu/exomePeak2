...
Using these the datasets single based resolution (e.x. data generated by m6A-CLIP-seq or m6A-miCLIP-seq techniques) as the reference sites, exomePeak2 could provide a more accurate and consistent quantification from MeRIP-seq data.
...
For MeRIP-seq experiment with interactive design (with control and treatment groups), use the following code:
