...
If only IP and input samples are provided, the peak statistics are calculated from the ${\beta}_{i,1}$ terms in the following Poisson GLMs:
...
The peak statistics calculated in the differential modification setting are based on the interactive coefficient ${\beta}_{i,3}$ in the following regression equation:
