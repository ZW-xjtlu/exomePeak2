...
- name: Zhen Wei, Jia Meng
  affiliation: Department of Biological Sciences, Xi’an Jiaotong-Liverpool University,
    Suzhou, Jiangsu, 215123, China; Institute of Integrative Biology, University of
...
graphics: yes
vignette: |
  %\VignetteIndexEntry{The exomePeak2 user's guide} %\VignetteEngine{knitr::rmarkdown} %\VignettePackage{exomePeak2} %\VignetteEncoding{UTF-8}
---
