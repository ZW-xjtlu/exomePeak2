...
The peak statistics calculated in the differential modification setting are based on the interactive coefficient ${\beta}_{i,3}$ of the following regression equation:
