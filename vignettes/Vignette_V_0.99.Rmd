...
Under the default settings, the peak statistics are derived from the ${\beta}_{i,1}$ terms in the following regression design under the **GLM (Generalized Linear Model)** developed by **DESeq2**:
